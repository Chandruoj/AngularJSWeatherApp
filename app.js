...
mainApp.service('GeolocationService', function($http){
    this.getLocation = function(city, key){
        return $http.post("https://api.openweathermap.org/data/2.5/weather?q=" + city, "&appid=" + key);
    }
});
    ...
    factory.requestWeatherByLocation = function(a,b) {
        ...
        var request = {
            ...
            params: {
                ...
                units: 'metric',
                cnt: '7',
                appid: 'bcbca90e68f51ff657ecad3e293cfc04'
            }
        };
        return $http(request);        
    }
